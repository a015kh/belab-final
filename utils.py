...
def loadPose(a=256,b=256):
    ...
    imgs.append(load_image('{:02}-b'.format(4)+'.png',a, b))
    imgs.append(load_image('{:02}-g'.format(4)+'.png', a, b))
    imgs.append(load_image('{:02}-r'.format(4)+'.png', a, b))
    imgs.append(load_image('{:02}-b'.format(5)+'.png',a, b))
    imgs.append(load_image('{:02}-g'.format(5)+'.png', a, b))
    imgs.append(load_image('{:02}-r'.format(5)+'.png', a, b))
    imgs.append(load_image('{:02}-b'.format(8)+'.png',a, b))
    imgs.append(load_image('{:02}-g'.format(8)+'.png', a, b))
    imgs.append(load_image('{:02}-r'.format(8)+'.png', a, b))
    imgs.append(load_image('punch.png', 128, 128))
    imgs = np.array(imgs)
    return imgs
